...
def get_params():
    ...
    args.add_argument("-path", "--data_path", default="./Nell-One", type=str) 
    args.add_argument("-seed", "--seed", default=1047, type=int)
    ...
    args.add_argument("-state_dir", "--state_dir", default="./ckpt_state", type=str)
